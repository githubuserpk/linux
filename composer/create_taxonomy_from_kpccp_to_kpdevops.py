...
def create_taxonomy_from_kpccp_to_kpdevops(
    ...
    display_name: str = "create_taxonomy_from_kpccp_to_kpdevops",

):

    print("in create_taxonomy_from_kpccp_to_kpdevops")
...
# DAG definitions 
with DAG(dag_id='create_taxonomy_from_kpccp_to_kpdevops',
         catchup=False,
...
# Dummy strat task   
    ...
    create_taxonomy_from_kpccp_to_kpdevops = PythonOperator(
    task_id='create_taxonomy_from_kpccp_to_kpdevops',
    python_callable=create_taxonomy_from_kpccp_to_kpdevops,
    dag=dag)
...
start >> create_taxonomy_from_kpccp_to_kpdevops >> end
